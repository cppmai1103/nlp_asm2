...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_path", type=str, default='results_undersampling', help="Path to trained model folder")
    parser.add_argument("--parquet_path", type=str, default='test.parquet', help="Path to input parquet file with ID and code")
    parser.add_argument("--output_path", type=str, default='codeBERT_undersampling.csv', help="Path to save predictions CSV")
