...
class WeightedTrainer(Trainer):
    ...
    # ✅ Add **kwargs so Trainer can pass num_items_in_batch etc.
    def compute_loss(self, model, inputs, return_outputs=False, **kwargs):
        labels = inputs.get("labels")
        # Forward pass (exclude labels from model inputs)
...
class CodeBERTTrainer:
    def __init__(
        ...
        self.class_weights = None  # will be set after loading data
    ...
    def load_and_prepare_data(self):
        ...
        try:
            ...
            if self.use_weighted_ce:
                ...
                logger.info(f"Using class-weighted CE. Weights (by label id):\n{self.class_weights}")
    ...
    def train(
        ...
        training_args = TrainingArguments(
            ...
            logging_dir='./logs',
            logging_steps=100,
            eval_strategy="steps",  # if your HF version complains, change to evaluation_strategy
            eval_steps=500,
            save_strategy="steps",
            save_steps=500,
        ...
        # Choose Trainer class based on flag
        TrainerClass = WeightedTrainer if self.use_weighted_ce else Trainer
        ...
        trainer = TrainerClass(
            ...
            # For WeightedTrainer; ignored by base Trainer
            class_weights=self.class_weights if self.use_weighted_ce else None,
        )
...
def main():
    ...
    parser.add_argument('--output_dir', default='./results_weightCE', help='Output directory')
    parser.add_argument('--epochs', type=int, default=3, help='Number of training epochs')
    parser.add_argument('--batch_size', type=int, default=32, help='Batch size')
    parser.add_argument('--learning_rate', type=float, default=2e-5, help='Learning rate')
    parser.add_argument('--max_length', type=int, default=128, help='Maximum sequence length')
    parser.add_argument('--weighted_ce', action='store_true', help='Use class-weighted cross entropy loss')
    ...
    trainer = CodeBERTTrainer(
        ...
        use_weighted_ce=args.weighted_ce,
    )
